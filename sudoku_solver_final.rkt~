...
(define solve-button (new button% [parent panel2] 
                          ...
                          [min-width 290]
                          [min-height 100]
                          [callback  (lambda (button event) (print-puzzle (step-solve-sudoku curr-sudoku #f) 0 0))]))

(define step-button (new button% [parent panel2] 
                          [label "Step"]
                          [min-width 290]
                          [min-height 100]
                          [callback  (lambda (button event) (print-puzzle (step-solve-sudoku curr-sudoku #t) 0 0))]))
